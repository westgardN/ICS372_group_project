...
public class ReadingTest {
	...
	public final void testReadingToString() {
		...
		String expected = "Reading " + reading.getId() + " for patient " + reading.getPatientId() + " taken on " + reading.getDate().format(formatter) 
		+ " taken at " + reading.getClinicId() + " has a value of " + reading.getValue();
	...
	/**
	 * Test method for {@link edu.metrostate.ics372.thatgroup.clinicaltrial.beans.Reading#getPatientId()} and
	...
	/**
	 * Test method for {@link edu.metrostate.ics372.thatgroup.clinicaltrial.beans.Reading#getId()} and
	...
	/**
	 * Test method for {@link edu.metrostate.ics372.thatgroup.clinicaltrial.beans.Reading#getDate()} and
	...
	/**
	 * Test method for {@link edu.metrostate.ics372.thatgroup.clinicaltrial.beans.Reading#getValue()} and
	...
	/**
	 * Test method for {@link edu.metrostate.ics372.thatgroup.clinicaltrial.beans.Reading#getClinicId()} and
