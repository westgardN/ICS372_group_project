...
public class TrialTests {
	...
	private final String PROP_ID = "test";
	private final String PROP_ID_B = "testB";
	private final String PROP_START_DATE = "testStartDate";
	private final String PROP_END_DATE = "testEndDate";
