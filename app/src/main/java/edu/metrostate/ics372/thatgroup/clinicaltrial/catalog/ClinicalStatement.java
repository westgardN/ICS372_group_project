...
public class ClinicalStatement {
    ...
    public static final String GET_TRIAL = "SELECT id, start_date, end_date FROM trials WHERE id = :id";

    // Clinics
    public static final String INSERT_CLINIC = "INSERT INTO clinics (id, name, trial_id) VALUES(?,?,?)";
    public static final String GET_CLINIC = "SELECT id, name, trial_id FROM clinics WHERE id = :id";
    ...
    public static final String GET_PATIENT = "SELECT id, trial_id, start_date, end_date FROM patients WHERE id = :id AND trial_id = :trialId";
    ...
    public static final String GET_READING = "SELECT id, patient_id, clinic_id, type, date, value FROM readings WHERE id = :id";
    ...
    public static final String DELETE_TRIAL = "";
    public static final String UPDATE_TRIAL = "";
    public static final String GET_ALL_TRIALS = "SELECT * FROM trials";
}