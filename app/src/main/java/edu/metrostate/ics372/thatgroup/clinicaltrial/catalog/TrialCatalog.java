...
public interface TrialCatalog {
     ...
     *
     * @param trial the id of the <code>Trial</code> to be retrieved and activated
     ...
     */
    boolean init(Trial trial) throws TrialCatalogException;
    ...
    boolean update(Trial trial);

    LiveData<TrialEntity> get(Trial trial);

    boolean remove(Trial trial);

    /**
     * Returns true if the specified clinic exists within this catalog;
     * otherwise false is returned.
     *
     * @param clinic the id of the <code>Clinic</code> to be checked must be
     ...
     */
    boolean exists(Clinic clinic) throws TrialCatalogException;
     ...
     * returned.
     *
     * @param clinic the <code>Clinic</code> to be insert in to the catalog.
     ...
     */
    boolean insert(Clinic clinic) throws TrialCatalogException;
     ...
     * is returned.
     *
     * @param clinic the id of the <code>Clinic</code> to be retrieved must be
     ...
     *                               was encountered.
     */
    LiveData<ClinicEntity> get(Clinic clinic) throws TrialCatalogException;
     ...
     *                               was encountered.
     */
    LiveData<Clinic> getDefaultClinic() throws TrialCatalogException;
     ...
     * otherwise false is returned.
     *
     * @param clinic the clinic must not be null and the id of the specified clinic
     ...
     *                               was encountered.
     */
    boolean update(Clinic clinic) throws TrialCatalogException;
     ...
     */
    boolean remove(Clinic clinic) throws TrialCatalogException;

    /**
     * Returns true if the specified patient exists within this catalog;
     * otherwise false is returned.
     *
     * @param patient the id of the <code>Patient</code> to be checked must be
     ...
     *                               another type of error occurred.
     */
    boolean exists(Patient patient) throws TrialCatalogException;
     ...
     * returned.
     *
     * @param patient the <code>Patient</code> to be insert in to the catalog.
     ...
     */
    boolean insert(Patient patient) throws TrialCatalogException;
     ...
     * is returned.
     *
     * @param patient the id of the <code>Patient</code> to be retrieved must be
     ...
     *                               was encountered.
     */
    LiveData<Patient> get(Patient patient) throws TrialCatalogException;
     ...
     *                               was encountered.
     */
    LiveData<Patient> getDefaultPatient() throws TrialCatalogException;
     ...
     * otherwise false is returned.
     *
     * @param patient the patient must not be null and the id of the specified patient
     *                must be a valid id for a patient within this catalog.
     * @return true if the updated information was saved; otherwise false is returned.
     * @throws TrialCatalogException indicates that patient is null or an error
     *                               was encountered.
     */
    boolean update(Patient patient) throws TrialCatalogException;
     ...
     */
    boolean remove(Patient patient) throws TrialCatalogException;
     ...
     * otherwise false is returned.
     *
     * @param reading the id of the <code>Reading</code> to be checked must be
     ...
     *                               another type of error occurred.
     */
    boolean exists(Reading reading) throws TrialCatalogException;
     ...
     * returned.
     *
     * @param reading the <code>Reading</code> to be insert in to the catalog.
     ...
     */
    boolean insert(Reading reading) throws TrialCatalogException;
     ...
     * is returned.
     *
     * @param reading the id of the <code>Reading</code> to be retrieved must be
     ...
     *                               was encountered.
     */
    LiveData<Reading> get(Reading reading) throws TrialCatalogException;
     ...
     * otherwise false is returned.
     *
     * @param reading the reading must not be null and the id of the specified reading
     *                must be a valid id for a reading within this catalog.
     * @return true if the updated information was saved; otherwise false is returned.
     * @throws TrialCatalogException indicates that reading is null or an error
     *                               was encountered.
     */
    boolean update(Reading reading) throws TrialCatalogException;
     ...
     *                               was encountered.
     */
    boolean remove(Reading patient) throws TrialCatalogException;
     ...
     */
    LiveData<List<ClinicEntity>> getClinics() throws TrialCatalogException;
     ...
     *                               an error was encountered.
     */
    LiveData<List<Patient>> getPatients() throws TrialCatalogException;
     ...
     *                               an error was encountered.
     */
    LiveData<List<Patient>> getActivePatients() throws TrialCatalogException;
     ...
     *                               an error was encountered.
     */
    LiveData<List<Patient>> getInactivePatients() throws TrialCatalogException;
     ...
     *                               an error was encountered.
     */
    LiveData<List<Reading>> getReadings() throws TrialCatalogException;
     ...
     */
    LiveData<List<Reading>> getReadings(Patient patient) throws TrialCatalogException;
     ...
     *                               is no active trial or an error was encountered.
     */
    LiveData<List<Reading>> getReadings(Clinic clinic) throws TrialCatalogException;
}
